package com.karlo.Dostikarlo.ActivitiesFragments.VideoCalling;
...
import com.karlo.Dostikarlo.ActivitiesFragments.VideoCalling.util.CameraCapturerCompat;
...
public class VideoActivity extends AppCompatActivity {
    ...
    public void showCallingDialog() {
        ...
        if(callerImage !=null) {
            userImage.setController(com.karlo.Dostikarlo.SimpleClasses.Functions.frescoImageLoad(callerImage,R.drawable.ic_user_icon,userImage,false));

        }else {
            userImage.setController(com.karlo.Dostikarlo.SimpleClasses.Functions.frescoImageLoad(ContextCompat.getDrawable(VideoActivity.this,R.drawable.ic_user_icon),userImage,false));
        }
