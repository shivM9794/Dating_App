package com.karlo.Dostikarlo.ActivitiesFragments.Matchs;
...
import com.karlo.Dostikarlo.MainMenu.MainMenuActivity;
...
public class Match_F extends RootFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(bundle!=null){
            ...
            user1Pic.setController(com.karlo.Dostikarlo.SimpleClasses.Functions.frescoImageLoad(imageUrl,R.drawable.ic_user_icon,user1Pic,false));


            String otherImageUrl=withoutPurchaseItem.getPicture();
            user2Pic.setController(com.karlo.Dostikarlo.SimpleClasses.Functions.frescoImageLoad(otherImageUrl,R.drawable.ic_user_icon,user2Pic,false));
