...
import com.karlo.Dostikarlo.Models.BlockUsersModel;
...
public class BlockedUsersAdapter extends RecyclerView.Adapter<BlockedUsersAdapter.CustomViewHolder>{
    ...
    public void onBindViewHolder(final BlockedUsersAdapter.CustomViewHolder holder, final int i) {
        ...
        holder.userImage.setController(com.karlo.Dostikarlo.SimpleClasses.Functions.frescoImageLoad(item.blockedUser.image,R.drawable.ic_user_icon,holder.userImage,false));
