...
import com.karlo.binderstatic.Models.MatchModel;
...
import com.karlo.Dostikarlo.ActivitiesFragments.Accounts.Login_A;
import com.karlo.Dostikarlo.ActivitiesFragments.Matchs.Match_F;
import com.karlo.Dostikarlo.Adapters.UserAdapter;
...
//
    ...
    public void onClick(View v) {
        ...
        switch (id){
            case R.id.cross_btn:
                clearBackStack();
                com.karlo.Dostikarlo.SimpleClasses.Functions.swipeLeft(cardStackView);
                break;

            case R.id.heart_btn:
                clearBackStack();
                com.karlo.Dostikarlo.SimpleClasses.Functions.swipeRight(cardStackView);
                break;
            ...
            case R.id.supperlike_btn:
                clearBackStack();
                com.karlo.Dostikarlo.SimpleClasses.Functions.swipeTop(cardStackView);
                break;
