package com.karlo.binderstatic;

import android.content.Context;

import com.karlo.binderstatic.Models.CreditModel;
import com.karlo.binderstatic.Models.FreeVideoCreditModel;
...
public class Constants {
    ...
    public final static String BASE_URL = "https://goritransport.services/md/mobileapp_api";
    public static final String API_KEY = "https://goritransport.services/md/mobileapp_api";
    ...
    public static final String TWILIO_FUNCTION_LINK = "https://ceil-heron-4938.twil.io/video-Token";
   

    public static String gifApiKey1 ="FnKEymS7qqjFKS2XvrFKdXGwvfzRcXEp";
