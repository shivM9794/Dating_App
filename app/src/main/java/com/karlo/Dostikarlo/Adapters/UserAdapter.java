package com.karlo.Dostikarlo.Adapters;
...
/**
 * Created by karlo on 10/15/2018.
 */
public class UserAdapter extends ArrayAdapter<NearbyUserModel> {
    ...
    public View getView(int position, View contentView, ViewGroup parent) {
        ...
        if(spot.imagesUrl != null){
            ...
            holder.image.setController(com.karlo.Dostikarlo.SimpleClasses.Functions.frescoImageLoad(model.getImage(),R.drawable.ic_user_icon,holder.image,false));


        }else {
            holder.image.setController(com.karlo.Dostikarlo.SimpleClasses.Functions.frescoImageLoad(ContextCompat.getDrawable(context,R.drawable.ic_user_icon),holder.image,false));
        }
